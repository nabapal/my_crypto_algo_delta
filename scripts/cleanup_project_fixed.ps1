...
Write-Host ""
Write-Host "Moving redundant backtest files..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Moving redundant documentation versions..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Moving debug and test files..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Moving duplicate/development files..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Moving performance comparison scripts..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Moving test directory files..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Remaining core files in project:" -ForegroundColor Cyan
